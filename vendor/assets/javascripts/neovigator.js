$(function() {
    ...
    $(function() {
      ...
      if (canvasSupported()) {
        ...
        p.init(p.ajax("/pjs/physics.pjs")+p.ajax("/pjs/donut.pjs")+p.ajax("/pjs/resource.pjs")+p.ajax("/pjs/node.pjs")+p.ajax("/pjs/edge.pjs")+p.ajax("/pjs/graph.pjs")+p.ajax("/pjs/network.pjs"));
        initialized = true;
