...
lgbt_experts = [User.find_or_create_by({provider: 'twitter', uid: '21692297', username: 'TheAdvocateMag', twitter: 'https://twitter.com/TheAdvocateMag', avatar: 'http://pbs.twimg.com/profile_images/487659151669985280/5CIqyU0-_normal.jpeg', name: 'The Advocate', bio: 'The World\'s Leading LGBT News Source'}),
...
police_militarization_experts = [User.find_or_create_by({provider: 'twitter', uid: '116625196', username: 'CopWatch', twitter: 'https://twitter.com/CopWatch', avatar: 'http://pbs.twimg.com/profile_images/378800000863401905/SnwA6aaJ_normal.jpeg', name: 'Copwatch', bio: 'The cops watch us. We get cameras to watch the cops. You can too. Ask us or groups like @Peoples_Justice for trainings.'}),
...
civil_rights_experts = [User.find_or_create_by({provider: 'twitter', uid: '29417304', username: 'deray', twitter: 'https://twitter.com/deray', avatar: 'http://pbs.twimg.com/profile_images/555381462107570176/TBtL-FxK_normal.jpeg', name: 'deray mckesson', bio: 'I will never betray my heart. Curator, connector, commited to ed equity. TFA alum. Bowdoin loyalist. Protestor. deray@thisisthemovement.org.'}),
