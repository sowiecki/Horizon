...
minimum_wage_experts = [User.find_or_create_by({provider: 'twitter', uid: '14512287', username: 'thinkprogress_i', twitter: 'https://twitter.com/thinkprogress_i', avatar: 'http://abs.twimg.com/sticky/default_profile_images/default_profile_6_normal.png', name: 'Think Progress', bio: 'Think Progress'}),
...
minimum_wage_issue.experts << paul

super_pac_issue = Issue.find_or_create_by({name: "Super PAC", description: ""})
politics_category.issues << super_pac_issue

#super PACS
super_pac_experts = [User.find_or_create_by({provider: 'twitter', uid: '11388132', username: 'lessig', twitter: 'https://twitter.com/lessig', avatar: 'http://pbs.twimg.com/profile_images/2822485013/e54012b6296106112b44465776d13d3c_normal.jpeg', name: 'Lessig', bio: 'law professor, reformer.'}),
