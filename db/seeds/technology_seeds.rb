...
cyber_experts = [User.find_or_create_by({provider: 'twitter', uid: '14127605', username: 'ejhilbert', twitter: 'https://twitter.com/ejhilbert', avatar: 'http://pbs.twimg.com/profile_images/484389990990766080/Dmq6xMdQ_normal.jpeg', name: 'E.J. Hilbert', bio: 'Managing Director for Kroll Cyber In the UK, Ex-FBI Special Agent in cyber crime and counterterrorism.  All opinions posted are my own !!!'}),
